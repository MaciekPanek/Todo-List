const t=document.querySelector(".main__box--top-submit"),e=document.querySelector(".main__box--top-input"),o=document.querySelector(".main__box--bottom-taskbox"),n=function(){let t=Array.from(o.querySelectorAll(".main__box--bottom-name")).map(function(t){return t.textContent});localStorage.setItem("tasks",JSON.stringify(t))},a=function(t){let e=`
...
//# sourceMappingURL=index.334dc13c.js.map
